...
public class UsersPresenter {
    ...
    //load users from Model to layout
    ...
    //"add new command"  translate to using Model called from users activity
    public void add() {
    ...
    //"delete command", called from UsersActivity translate to using later in Model
    public void clear() {
        view.showProgress();
